    ...
    return ftxui::CatchEvent(
            ...
            [this]()
            {
                ...
                auto interactive_window_1 = ftxui::vbox(
                    [&]()
                    {
                        ...
                        for (std::size_t i = 0; i < terminal_layout::interaction_window::interactive_window_1::height;
                             ++i)
                        {
                ...
                auto interaction_window =
                    ftxui::hbox({
                        ...
                        ftxui::text(" "),
                        log_window | ftxui::size(ftxui::WIDTH, ftxui::EQUAL,
        ...
        [this](ftxui::Event event)
        {
            ...
            if (event.is_mouse()) // mouse did something
            {
                ...
                {
                    terminal_state_ = callback_(input{
