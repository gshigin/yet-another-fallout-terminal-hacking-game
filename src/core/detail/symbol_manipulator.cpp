...
auto generate_words(std::size_t length, std::size_t count, rng_fref gen_next) noexcept -> std::array<std::string, 20> {
  ...
  if (length == 7) {
    word_array = {"KINESIS", "KINLESS", "BINDERS", "BUCKERS", "BUCKISH", "TURKISM", "AORTISM", "TOURISM", "MAURIST", "MARXISM", "DARKISH", "FASTISH", "PETTISH",
                  "SERFISH", "SERBIAN", "SENECAN", "SELECTS", "DIRECTS", "DEPICTS", "INDICTS", "INDENTS", "ASSENTS", "ARSENYL", "ACRINYL", "ARRIVAL", "VARICAL",
                  "VARIOLA", "CARIOCA", "CARANDA", "VARANUS", "PARADOS", "ABRADES", "PIRATES", "LYSATES", "REDATES", "REWARMS", "REMARRY", "LEMANRY", "BEFANCY",
                  "BESAUCE", "BELADLE", "VEXABLE", "WOOABLE", "WOMANLY", "WOMMALA", "WANGALA", "LANTANA", "MANTAPA", "MANDATS", "RANDALL", "JAWFALL", "HEWHALL",
                  "MECHAEL", "MACHAON", "MARSOON", "BALLOON", "GALLEIN", "DARREIN", "CARRYON", "CAMARON", "CANADOL", "CANDIOT", "CONCION", "CONTEMN", "CONVERT",
                  "CONGEST", "CONTUSE", "NONBASE", "DIABASE", "DISPACE", "DIAPASM", "DISCASE", "DISCOUS", "DIGITUS", "DOCIOUS", "ROYNOUS", "AGYNOUS", "AENEOUS",
                  "ADMETUS", "AMMITES", "ASEITAS", "EDEITIS", "EUECTIC", "CZECHIC", "CHECHIA", "RHACHIS", "ROTCHES", "VOUCHES", "CINCHES", "CANCHAS", "PANCHAX",
                  "PARCHED", "POTCHER", "MOUCHES", "POUNCES", "PLUSSES", "PLUNGER", "PLINKER", "PLINIAN", "CLIVIAS"};
  }
  if (length == 8) {
  ...
  if (length == 10) {
    word_array = {"DIFFUSEDLY", "DISPOSEDLY", "SUPPOSEDLY", "SUPPOSABLE", "PROPOSABLE", "COMPOSABLE", "COMMONABLE", "MOTIONABLE", "RATIONABLY", "NOTIONALLY",
  ...
  if (length == 11) {
    word_array = {
        "SCRIMPINGLY", "SHRINKINGLY", "THRILLINGLY", "THRONGINGLY", "SHRUGGINGLY", "SHRIEKINGLY", "SPRINGINGLY", "STRINGENTLY", "STRINGENDOS", "STRANGERDOM",
        "STRANGERING", "SQUANDERING", "UNWANDERING", "UNLINGERING", "ENDANGERING", "UNBANTERING", "UNHAMPERING", "UNHALTERING", "INFILTERING", "ENFETTERING",
        "EMBITTERING", "UNTITTERING", "UNDIFFERING", "UNSUFFERING", "UNSOLDERING", "RESOLDERING", "RESILVERING", "REGISTERING", "PLAISTERING", "PILASTERING",
        "SPLATTERING", "SPLATHERING", "INGATHERING", "UNWITHERING", "UNWONDERING", "UNCONDUCING", "UNCONVENING", "UNCOMBINING", "UNCONFIDING", "UNCONSUMING",
        "UNPRESUMING", "UNPREPARING", "REPREPARING", "REPROPOSING", "REPROACHING", "APPROACHING", "ENCROACHING", "ENWREATHING", "INBREATHING", "INTRENCHING",
        "RETRENCHING", "BEDRENCHING", "REBRANCHING", "RESEARCHING", "RESEARCHERS", "RESEARCHFUL", "RESEARCHIST", "PETRARCHIST", "PETRARCHIAN", "PETRARCHIZE",
        "TETRARCHATE", "TETRARCHIES", "HIERARCHIES", "HIERARCHIAL", "HIERARCHIZE", "HIERARCHIST", "HEPTARCHIST", "HEPTARCHIES", "PENTARCHIES", "POLYARCHIES",
        "POLYORCHISM", "POLYCROTISM", "POLYGLOTISM", "POLYGLOTTED", "POLYGLOTTER", "POLYGLOTTAL", "POLYODONTAL", "PERIODONTAL", "PERIORBITAL", "PERIPROCTAL",
        "PERITROCHAL", "PERITRICHAN", "PERITRICHIC", "PERIGRAPHIC", "MOGIGRAPHIC", "MONOGRAPHIC", "ALLOGRAPHIC", "ALLOMORPHIC", "CECOMORPHIC", "MESOMORPHIC",
        "HEMIMORPHIC", "MEROMORPHIC", "ENDOMORPHIC", "THEOMORPHIC", "ZYGOMORPHIC", "HALOMORPHIC", "HOMOMORPHIC", "MONOMORPHIC", "HYLOMORPHIC", "CYNOMORPHIC"};
  }
  if (length == 12) {
